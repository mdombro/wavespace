...
// Enables both the CDC class (for the CLI) and a vendor-specific interface
// used to stream raw PDM capture blocks over USB.
...
// Vendor interface buffers sized for streaming raw capture data.
